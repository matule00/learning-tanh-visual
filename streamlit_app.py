...
tilded_a = tilde_a(q,B,a)
st.latex(rf"{ass_on_a} = {round(tilded_a,2)}")

if tilded_a <= 1:
    st.write("The condition is not satisfied, enter the approperiate values!")
else:
    st.write("Satisfied")
    ...
    st.write("Assumption on k and j in order to have tail error below machine precission e_p:")
